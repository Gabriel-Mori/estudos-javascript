...
console.log(`A soma ultrapassou ${value}. Até aqui, o valor atual é ${sum}`);

// O código acima irá iterar através do array de números aleatórios
//  e irá adicionar cada número à variável sum. Se a soma ultrapassar 400,
// o loop será interrompido e a frase "A soma ultrapassou 400. Até aqui,
// o valor atual é RESULTADO_DA_SOMA." será exibida no console,
//  substituindo "RESULTADO_DA_SOMA" pelo valor atual de sum.
...
for (let i = 0; i < randomValues.length; i++) {
  ...
  if (isString) {
    stringAmout++;
    fourFirstString.push(randomValues[i]);
  }
  if (isBoolean) {
    booleanAmount++;
  }
...
const lastItem = fourFirstString[fourFirstString.length - 1];
const fourString = fourFirstString
  .join(", ")
...
console.log(`   
      ...
      - O array foi iterado por ${iterationAmout} vezes.`);
