...
const namesCopy = names.map((item) => item).sort(); // cria uma copia
var namesOrdened = [...names]; // cria uma copia.

namesOrdened.sort();
console.log("namesCopy", namesCopy);

console.log(names);
console.log(namesOrdened);
/*
  02
...
const charactersCopy = characters.map((item) => item);
charactersCopy.sort((a, b) => a.id - b.id);
var charactersOrdened = [...characters]; // Agora sim, cria-se um novo array.

charactersOrdened.sort((a, b) => a.id - b.id);

console.log("charactersCopy", charactersCopy);
console.log(charactersOrdened);
...
numberOrdened = [...numbers];

numberOrdened.sort((a, b) => a - b);
console.log(numbers);
console.log(numberOrdened);
...
peopleOrdened = [...people];

peopleOrdened.sort((a, b) => {
  if (a > b) {
    return -1;
  } else if (a < b) {
    return 1;
...
const newFilter = topBrazilmovies.filter(
  (item) => item.distributedBy === "Disney"
);
...
const newMovies = topBrazilmovies.map((item) => {
